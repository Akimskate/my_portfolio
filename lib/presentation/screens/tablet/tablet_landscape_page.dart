...
class TabletLandscapePage extends StatefulWidget {
  const TabletLandscapePage({super.key});

  @override
  State<TabletLandscapePage> createState() => _TabletPortraitPageState();
}

class _TabletPortraitPageState extends State<TabletLandscapePage> with SingleTickerProviderStateMixin {
